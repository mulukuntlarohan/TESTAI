...
import json
import random
from Knowledgebase import ResolutionEngine, KBInitializer, KBUpdater
...
class Game:
    ...
    def draw(self):
        ...
        # Draw agent, gold, pits, and Wumpus
        self.draw_agent()
        self.draw_gold()
        self.draw_pits()
        self.draw_wumpus()
